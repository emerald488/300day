...
const ROTATING_SUBTITLES = [
    ...
    'Дисциплина — это свобода от хаоса и лишних решений в голове',
    'Сделай минимум прямо сейчас — привычка важнее настроения и погоды',
    'Стрик — твой договор с будущим собой: не обнуляйся сегодня',
    'Не гонись за рекордом — строй базу, которая держит тебя каждый день',
    'Одна галочка сегодня — спокойнее голова и чище совесть завтра',
    'Тренировка — это голос: «я управляю собой, а не обстоятельствами»',
    'Дроби на подходы — сохрани качество, дыхание и технику',
    'Техника сначала — суставы потом скажут спасибо, а не болью',
    'Устал — снизь темп и объём, но оставь привычку живой',
    'Таймер планки включён — ты уже победил прокрастинацию',
    'Лестница шаг за шагом — выносливость растёт тихо, но надолго',
    'Каждый повтор — вклад в уверенность и самоуважение',
    'Твой прогресс — это календарь: отметка важнее настроения',
    '300 дней — это про характер и выбор, не про цифры',
    'Плюс один в день — и сила растёт даже в самые занятые дни',
    'Сегодняшний минимум — завтрашняя норма: просто начни движение',
    'Не ищи идеальный момент — создай его первым повтором',
    'День закрыт — характер укреплён: отметь и отпусти день'
];
